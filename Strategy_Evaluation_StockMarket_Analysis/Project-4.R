...
gain <- (savings - n*1000)
print(paste("Total Gain obtained from the investment in SPY irrespective of market up/down",gain))

#--------------------------------------------- STRATEGY-2 -----------------------------------------------------#

# Using TTR to buy or sell and invest or stay during the up and down in the market
# TTr has many technical analysis functions. 
...
spy_data_return$Strategy2_return <- NA
